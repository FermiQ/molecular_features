...
import numpy as np
from molreps.methods.geo_npy import coordinates_to_distancematrix,invert_distance,inversedistancematrix_to_coulombmatrix
from molreps.methods.props_py import element_list_to_value


def coulomb_matrix(atoms,coordinates):
    """
...
def bond_angles(atoms,coordinates,bond_table = None):
    pass