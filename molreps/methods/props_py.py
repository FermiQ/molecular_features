...
def get_atom_property_dicts(identifier):
    ...
    Returns:
        PropertyDict (dict): Dictionary of Properties.
    ...
    InverseGlobalProtonDict = {value:key for key,value in GlobalProtonDict.items()}
    if(identifier == "ToProton"):
        return GlobalProtonDict
    if(identifier == "FromProton"):
        return InverseGlobalProtonDict
