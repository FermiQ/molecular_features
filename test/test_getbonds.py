...
from molreps.methods import coordinates_to_distancematrix,invert_distance,get_bondtable_from_inversedistancematrix
...
bondtab = get_bondtable_from_inversedistancematrix(invd,a1)
